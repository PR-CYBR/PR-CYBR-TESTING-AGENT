...
variable "NOTION_AGENT_DATABASE_ID" {
  type        = string
  sensitive   = true
  description = "Target database for agent configuration in Notion"
}

variable "NOTION_LOG_DATABASE_ID" {
  type        = string
  sensitive   = true
  description = "Database used to store agent run logs in Notion"
}
